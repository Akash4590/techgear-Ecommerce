...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="group relative flex h-full flex-col rounded-xl border border-gray-200 bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:border-[#D8D6FE] hover:shadow-lg">
      ...
      {/* Product Name */}
      <h3 className="line-clamp-1 text-[14px] font-semibold leading-5 text-[#0B0B14]">
        {name}
      </h3>
      ...
      <button
        type="button"
        className="mt-auto flex w-full items-center justify-center gap-2 rounded-lg bg-[#4F46E5] px-4 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-[#4338CA]"
      >
