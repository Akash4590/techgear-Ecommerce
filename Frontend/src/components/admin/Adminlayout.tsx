...
const AdminLayout = () => {
  ...
  const handleNotificationsClick = () => {
    setShowNotifications((isOpen) => {
      ...
      if (nextState) {
        ...
        const seenOrderIds = notifications.map(
          (order) => order._id
        );

        localStorage.setItem(
          "techgear_admin_seen_orders",
  ...
  const handleNotificationOrderClick = () => {
    setShowNotifications(false);
  ...
  return (
    <div className="flex min-h-screen w-full max-w-full overflow-x-hidden bg-[#F8F9FC]">
        ...
        <header className="flex h-16 items-center justify-between gap-3 border-b border-gray-200 bg-white px-4 sm:px-8">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <button
              ...
              className="shrink-0 text-gray-500 transition-colors hover:text-[#4F46E5] lg:hidden"
          ...
          <div className="flex shrink-0 items-center gap-3 sm:gap-4">
            ...
            >
              <button
                ...
                className="relative cursor-pointer text-gray-500 transition-colors hover:text-[#4F46E5]"
              >
                <Bell size={19} />
              ...
              {showNotifications && (
                <div className="absolute right-0 top-8 z-50 w-72 rounded-lg border border-gray-200 bg-white p-2 shadow-lg">
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((order) => (
                      <button
                        type="button"
                        key={order._id}
                        onClick={handleNotificationOrderClick}
            ...
            <div
              ...
              <button
                ...
                className="flex items-center gap-2.5 rounded-lg p-1 transition-colors hover:bg-gray-50"
              ...
              >
                ...
                <span className="hidden text-sm font-semibold text-[#0B0B14] sm:inline">
                  {user?.name || "Admin"}
                </span>
              </button>

              {showProfileMenu && (
                <div className="absolute right-0 top-11 z-50 w-52 rounded-lg border border-gray-200 bg-white p-2 shadow-lg">
